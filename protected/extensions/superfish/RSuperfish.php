...
class RSuperfish extends CMenu
{
  ...
  */
  ...
  function makeOptions(){
    ...
    $options['itemCssClass'] = $this->itemCssClass;
  ...
  function run(){
      $this->activeCssClass='current-menu-item current_page_item';
      $this->itemCssClass='menu-item';
      $this->htmlOptions['id'] = "topnav";
      $this->submenuHtmlOptions['class'] = "sub-menu";
