            ...
            if(!empty($work->photo_portfolio)){
                ...
                if(count($photosArr)>0){
                    foreach($photosArr as $photo){
                        ...
                        //<a href="images/works/malusha/malusha_about.png" title="Центр семейного развития Малуша" rel="prettyPhoto[gallery1]" style="display:none;"><img src="images/works/malusha/malusha_about.png" alt=""/></a>
                    }
                }
            }
        ?>
